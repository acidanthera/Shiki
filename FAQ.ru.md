...
Требуется изолировать вызов `IntelAccelerator::PAVPCommandCallback` в `AppleIntelHD5000Graphics`, потому как виртуальный вызов `SafeForceWake` в этой функции  приводит к взаимной блокировке. На 10.11.6 и 10.12 актуальна замена `<48 89 8b a8 00 00 00>` на `<90 90 90 90 90 90 90>` в AppleIntelFramebufferAzul. Несмотря на исправление части зависаний этот патч решает только часть проблем с картой, аппаратное декодирование видео может не работать после выхода из сна. Подробности на [Applelife](https://applelife.ru/threads/shiki-patcher-polzovatelskogo-urovnja.1349123/page-8#post-608892).
...
_Спасибо: 07151129, Andrey1970, Сашко666, chrome, family1232009, garcon, iDark Soul, igork, m-dudarev, Mieze, Quadie, savvas, tatur_sn и другим._
